...
public class GraphPath
{
    ...
    public static class Node
    {
		...
		Node(Test key, Test value)
		{
			this(new Test(key.toString()+"\t"+value.toString()));
		}
		Public String getId()
		{
			return this.id；
	...
	public static class GraphPathMapper extends Mapper<Object, Text, Text, Text>
	{
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException
		{
			...
			if (n.getState().equals("C"))
			{
				...
				context.write(new Text(n.getId()), new Text(n.getNeighbours()+"\t"+n.getDistance()+"\t"+n.getDistance()+"\t"+"D"));
	...
	public static class GraphPathReducer extends Reducer<Text, Text, Text, Text>
	{
		public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException
		{
			...
			for (Text t:values)
			{
				...
				if ( n.getState().equals("D") || ( n.getState().equal("C") && state.equal("P")))
					state = n.getState();
			}
	...
	public static void main(String[] args) throws Exception
	{
		...
		System.exit(job.waiForCompletion(true)?0:1);
	}
}
